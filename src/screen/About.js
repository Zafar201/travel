  ...
  return (
    ...
    >
      ...
      <Container className="about-2">
        ...
        <Row>
          <p>
            ...
            India. Tawi Explores offers travelers the convenience to choose and
            book the best luxury and ultra-luxury resort online. The company
            empowers travelers from all tier cities and towns in India to access
            the best resorts in the Maldives with a few clicks. <br /> <br />
            The two founders conceptualized to provide the best Maldives travel
            experience to every Indian laid the foundation for Tawi Explores. A
            cumulative 30 years’ of both the founders in Maldives
            ...
            <br />
            Tawi Explores uncovered the accessibility to the Maldives to Indians
            and built a robust relationship with trustworthy and exclusive
            luxury and ultra-luxury resorts in the Maldives to provide a real
            royal experience to our customers. The service caters to the needs
            of both B2B customers and B2C customers. The company provides
            customizable services to cater the individual needs. Tawi Explores
            has a highly enthusiastic and energetic team to meet customers'
            needs.
          </p>
        </Row>
      </Container>
      ...
      <Container>
        ...
        <Row>
          <Col md={{ span: 3, offset: 3 }} className='team-box' style={{marginRight:"20px"}}>
             <Row>
...
<br /> Asst. Manager</p>
        ...
        <Row style={{paddingTop:"40px"}}> 
          <Col md={{ span: 3, offset: 3 }} className='team-box' style={{marginRight:"20px"}}>
             ...
             <Row>
               <p>Sales & Reservation <br /> Executive</p>
             </Row>
             <Row>
